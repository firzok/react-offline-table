            ...
            viewData.map((row, index) => {
                ...
                if (props.showActions) {
                    if (typeof action.icon === 'string') {
                        ...
                        thisRow.push(<td className="text-center">
                            {
                                props.actions.map((action, actionIdx) => <FontAwesomeIcon key={ actionIdx } icon={ action.icon } className={ action.className ? action.className : "" } onClick={ () => action.callBack(row) } />)
                            }
                        </td>)
                    }
                }
                            ...
                            <td className="text-center">
                                {
                                    col.map((action, actionIdx) => {
                                        if (typeof action.icon === 'string') {
                                            return <i key={ actionIdx } className={ action.icon } onClick={ () => action.callBack(row) } />
                                        } else {
                                            return <FontAwesomeIcon key={ actionIdx } icon={ action.icon } className={ action.className ? action.className : "" } onClick={ () => action.callBack(row) } />
                                        }
                                    })
                                }
                            </td>
